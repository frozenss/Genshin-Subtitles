...
namespace GI_Subtitles.Core.Overlay
{
    ...
    /// the single source for both the display string and the plain text
    /// string; until the colored layer lands both compose identically, so
    /// what the window shows is exactly what selection and row copy read.
    /// </summary>
