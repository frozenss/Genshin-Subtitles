...
namespace GI_Subtitles.Core.Overlay
{
    ...
    /// points only. Per-frame movement logging was removed with issue #39.
    /// Every public method is [Conditional("DEBUG")] and every body is
    /// compiled out unless DEBUG is defined, so Release artifacts carry none
    /// of this code.
    ///
