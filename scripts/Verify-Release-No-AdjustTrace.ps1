...
# UTF-16LE and must be absent from the Release exe. (Some strings such as
# SetWindowLong verdicts share production identifiers, so only diagnostic-only
# wording is probed.) The per-frame movement probes and their diagnostic-only
# Win32 imports were removed with issue #39; the one remaining diagnostic
# import, GetWindowLong, is also a production import and cannot be probed.
